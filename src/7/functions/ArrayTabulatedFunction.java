...
public class ArrayTabulatedFunction implements TabulatedFunction, Serializable {
    ...
    /**
     * Опишите в классах ArrayTabulatedFunction и LinkedListTabulatedFunction классы фабрик ArrayTabulatedFunctionFactory и LinkedListTabulatedFunctionFactory
     * Классы реализуют интерфейс фабрики и порождают объекты соответствующих классов табулированных функций.
     * Классы фабрик должны быть вложенными и публичными
     * */
    ...
    public Iterator<FunctionPoint> iterator() {
        return new Iterator<FunctionPoint>() {
            ...
            public FunctionPoint next() {
                if(this.hasNext()){
                    return new FunctionPoint(points[++current]);
                }else{
